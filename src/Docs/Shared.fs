...
let fixDocsView fileName client =
    Html.div [
        Html.a [
            prop.href (sprintf "https://github.com/DataBreezeUG/Feliz.GridLayout/blob/main/src/Docs/views/Feliz.GridLayout/%s.fs" fileName)
...
let installationView packageName =
    Html.div [
        ...
        Bulma.content [
            ...
            code ("npm install --save react-grid-layout")
        ]
    ]
